...
public class Arrays {
     ...
     */
    public static @SearchIndexFor({"#1"}) int binarySearch(@Nullable Object[] a, @Nullable Object key) {
        return binarySearch0(a, 0, a.length, key);
    }
     ...
     * @since 1.6
     */
    public static @SearchIndexFor({"#1"}) int binarySearch(@Nullable Object[] a, @IndexOrHigh({"#1"}) int fromIndex, @IndexOrHigh({"#1"}) int toIndex,
                                   @Nullable Object key) {
        rangeCheck(a.length, fromIndex, toIndex);
        return binarySearch0(a, fromIndex, toIndex, key);
    }
     ...
     */
    @Pure
    public static boolean equals(@PolyNull Object @GuardSatisfied  @Nullable [] a, @PolyNull Object @GuardSatisfied  @Nullable [] a2) {
        if (a==a2)
            return true;
        if (a==null || a2==null)
            return false;
     ...
     */
    public static void fill(@PolyNull Object[] a, @PolyNull Object val) {
        for (int i = 0, len = a.length; i < len; i++)
            a[i] = val;
    }
     ...
     *         runtime type that can be stored in the specified array
     */
    public static void fill(@PolyNull Object[] a, @IndexOrHigh({"#1"}) int fromIndex, @IndexOrHigh({"#1"}) int toIndex, @PolyNull Object val) {
        rangeCheck(a.length, fromIndex, toIndex);
        for (int i = fromIndex; i < toIndex; i++)
            a[i] = val;
    }
     ...
     */
    @Pure
    public static int hashCode(@PolyNull Object a @GuardSatisfied  @Nullable []) {
        if (a == null)
            return 0;
     ...
     */
    @Pure
    public static int deepHashCode(@PolyNull Object a @GuardSatisfied  @Nullable []) {
        if (a == null)
            return 0;
     ...
     */
    @Pure
    public static boolean deepEquals(@PolyNull Object @GuardSatisfied  @Nullable [] a1, @PolyNull Object @GuardSatisfied  @Nullable [] a2) {
        if (a1 == a2)
            return true;
        if (a1 == null || a2==null)
            return false;
     ...
     */
    @SideEffectFree
    public static String deepToString(@PolyNull Object @Nullable [] a) {
        if (a == null)
            return "null";
